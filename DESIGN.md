...
| tavera-kyushoku | 給食献立表の画像/PDF解析（v23・dishes+ingredients+allergenHits・URLモード内部fetch対応・429リトライ＋UA偽装＋マジックバイト判定＋response_schemaでJSON構造強制＋thinking無効化＋認証/利用回数制限・アレルゲン検出対応） | オン | gemini-2.5-flash |
